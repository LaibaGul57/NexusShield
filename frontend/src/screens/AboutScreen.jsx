...
<ul>
  ...
  <li>Give real-time alerts for risky actions.</li>
      ...
      <section className="about-section mission-section">
        <div className="mission-content">
          <div className="mission-text">
            <h2>Our Mission</h2>
            <ul>
              <li>Provide real-time alerts and nudges to prevent risky online behavior.</li>
              ...
              <li>Offer a web-based dashboard for educators and researchers to monitor anonymized user trends.</li>
            </ul>
          </div>
      ...
      <section className="about-section core-functions-section">
        ...
        <div className="core-content">
          <div className="core-text">
            <ul>
              <li>Real-time nudges for risky digital actions</li>
              <li>Interactive learning modules and quizzes</li>
              <li>Behavioral tracking for user awareness improvement</li>
              <li>Data visualization of anonymized trends on web dashboard</li>
