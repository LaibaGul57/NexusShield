...
// ✅ Backend URL (Apne system ke IP ke mutabiq check karlein)
...
const ProgressReportScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    const userId = "Laiba Gul"; // Dynamic user ID
   ...
   fetch(`${BASE_URL}/api/progress/${userId}`)
      ...
      .then((data) => {
        // Database attributes ko state se map kar rahe hain
        setDailyData({
          date: new Date().toLocaleDateString(),
          lessonsCompleted: data.lessonsCompleted || 0,
          quizzesAttempted: data.quizzesAttempted || 0,
  ...
  // ✅ Chart Data connected to Real State
  const chartData = [
    {
      name: "Lessons",
      population: dailyData.lessonsCompleted,
      color: "#00E5FF",
      legendFontColor: "#fff",
      legendFontSize: 12,
    },
    {
      name: "Quizzes",
      population: dailyData.quizzesAttempted,
      color: "#4CAF50",
      legendFontColor: "#fff",
      legendFontSize: 12,
    },
    {
      name: "Score",
      population: dailyData.quizScore,
      color: "#FF9800",
      legendFontColor: "#fff",
      legendFontSize: 12,
    },
...
const styles = StyleSheet.create({
  ...
  dateText: { fontSize: 16, color: "#ccc", marginBottom: 15, textAlign: "center" },
  summaryBox: { backgroundColor: "rgba(255,255,255,0.1)", borderRadius: 20, padding: 20, marginBottom: 20, borderWidth: 1, borderColor: "rgba(255,255,255,0.2)" },
  summaryTitle: { fontSize: 18, color: "#fff", fontWeight: "600", marginBottom: 15, textAlign: "center" },
  row: { flexDirection: "row", justifyContent: "space-between", marginVertical: 6 },
  label: { color: "#ffffff", fontSize: 16 },
  value: { color: "#11d82f", fontWeight: "600", fontSize: 16 },
  chartTitle: { fontSize: 18, color: "#fff", fontWeight: "600", textAlign: "center", marginBottom: 15 },
  messageBox: { backgroundColor: "rgba(255,255,255,0.1)", flexDirection: "row", alignItems: "center", padding: 15, borderRadius: 15, borderWidth: 1, borderColor: "rgba(255,255,255,0.2)", marginTop: 25 },
  behaviorText: { color: "#FFD700", fontSize: 15, marginLeft: 10, flexShrink: 1 },
});